from random import randint  # импортируем функцию из модуля рандом для дальнейшей генерации чисел
...
def get_unique_list_numbers(start_, end_, len_) -> list[int]:  # аргументы: начало, конец, размер диапазона
    ...
    while len(list_) < len_:  # ограничиваем длину списка
        numb = randint(start_, end_)  # выбираем случайное число из указанного диапазона
